                ...
                try:
                    ...
                    if mongo_uri.startswith("mongodb+srv://"):
                        ...
                        try:
                            ...
                            # ✅ FIX: Fail fast on DNS error - skip DNS retry loop
                            # Let connection attempt handle retries instead
                            logger.info("DNS failed — continuing to connection attempt (no retry delay)")
                            # Remove continue here so we proceed to actual connection
